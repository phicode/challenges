...
func DijkstraAllWithCost[T comparable](
	...
	q := lib.NewHeapWithUpdater[*NodeAll[T]](nodes, nodeAllIsLess[T], updateNodeAllIndex[T])
...
// NodeAll is a graph node which tracks all previous nodes (Prev) with equal Distance
...
func nodeAllIsLess[T any](a, b *NodeAll[T]) bool {
	return a.Distance < b.Distance
}
func updateNodeAllIndex[T any](a *NodeAll[T], i int) {
	a.idx = i
}
